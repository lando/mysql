...
* Fixed MySQL 8.4 startup failure caused by setting removed `default_authentication_plugin` variable [#69](https://github.com/lando/mysql/issues/69) [#72](https://github.com/lando/mysql/issues/72)
